...
// the id is generated by the calling app (e.g. Ramsey\Uuid\Uuid::uuid4()->toString()) — the SDK never generates ids itself
$created = $this->manufacturingApi->createProductionLine(
    CreateProductionLine::create(id: $newId, name: 'Line A', description: 'desc', active: true),
);

$updated = $this->manufacturingApi->updateProductionLine(
    $id,
    UpdateProductionLine::create(name: 'Line A', active: false),
);
